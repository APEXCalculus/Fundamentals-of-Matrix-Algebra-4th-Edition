...
$$C_{4,3} = (-1)^{4+3}\ttb_{4,3} = (-1)\ttb_{4,3}.$$ Once we learn how to compute determinants for matrices larger than $2\times 2$ we can come back and finish this exercise.}\\ % \eexset
