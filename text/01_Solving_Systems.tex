...
\item How many points are needed to determine the coefficients of a 5\textsuperscript{th} degree polynomial?
}
...
\example{ex_application_2}{A lady takes a 2-mile motorized boat trip down the Highwater River, knowing the trip will take 30 minutes. She asks the boat pilot ``How fast does this river flow?'' He replies ``I have no idea, lady. I just drive the boat.''\medskip 

\noindent She thinks for a moment, then asks ``How long does the return trip take?'' He replies ``The same; half an hour.'' She follows up with the statement, ``Since both legs take the same time, you must not drive the boat at the same speed.''\medskip

\noindent ``Naw,'' the pilot said. ``While I really don't know exactly how fast I go, I do know that since we don't carry any tourists, I drive the boat twice as fast.''\medskip

\noindent The lady walks away satisfied; she knows how fast the river flows. \medskip

\noindent (So how fast \textit{does} it flow?)}
...
We finish by interpreting this solution: the speed of the boat (going downstream) is $\frac{8}{3}$ mph, or $2.\overline{6}$ mph, and the speed of the river is $\frac{4}{3}$ mph, or $1.\overline{3}$ mph. All we really wanted to know was the speed of the river, at about 1.3 mph.}\\ %\eexset
