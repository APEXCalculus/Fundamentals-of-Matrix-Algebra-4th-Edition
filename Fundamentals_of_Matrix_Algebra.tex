...
\usepackage{array}
\newcolumntype{J}{>{\raggedleft\arraybackslash$}p{0.175in}<{$}} % right aligned, math mode, fixed width
\newcolumntype{K}{>{\raggedleft\arraybackslash$}p{0.21in}<{$}} % right aligned, math mode, fixed width
\newcolumntype{M}{>{\raggedleft\arraybackslash$}p{0.35in}<{$}} % right aligned, math mode, fixed width
\newcolumntype{N}{>{\raggedleft\arraybackslash$}p{0.5in}<{$}} % right aligned, math mode, fixed width
\newcolumntype{O}{>{\raggedright\arraybackslash$}p{2.0in}<{$}} % left aligned, math mode, fixed width

\newcolumntype{Q}{>{\raggedleft\arraybackslash$}p{0.075in}<{$}} % right aligned, math mode, fixed width
